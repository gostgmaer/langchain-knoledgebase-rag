...
- [ ] Upload a document with a distinctive, made-up product code → `202`, then background ingestion completes (`Background ingestion finished` in logs, nonzero `chunk_count`).
